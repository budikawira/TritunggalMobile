...
class TransferFragment : BaseFragment(), SimpleItemAdapter.OnItemClick {
    ...
    private fun uploadData() {
        ...
        var request = apiInterface.transferUpload(TransferUploadRequest(
            mId, itemIds))
    ...
    private fun init() {
        var request = apiInterface.transferInit(TransferInitRequest(mId))
            ...
            override fun onResponse(
                ...
                if (result != null) {
                    if (result.result == BaseResponse.RESULT_OK) {
                        ...
                        binding.textSrc.text = result.sourceLocationName
                        binding.textDest.text = result.destinationLocationName
