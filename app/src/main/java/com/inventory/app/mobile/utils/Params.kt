...
class Params {
    companion object {
        const val URL = "https://tritunggal.sistemdigital.my.id:444/"
        ...
        const val MENU_PLACEMENT_CREATE = "plc_create"
        ...
        const val MENU_SHIPMENT_CONFIRM = "shp_confirm"
        const val MENU_SHIPMENT_CREATE = "shp_create"
