...
import com.inventory.app.mobile.databinding.FragmentShipmentCreateBinding
...
class ShipmentCreateFragment : BaseFragment() {
    companion object {
        private const val TAG = "ShipmentCreateFragment"
    ...
    private var _binding: FragmentShipmentCreateBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentShipmentCreateBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonStart.setOnClickListener {
            ...
            val request = apiInterface.shipmentCreate(
    ...
    private fun showConfirmCompleteDialog() {
        ...
        builder.setMessage("Create shipment successful.")
        builder.setPositiveButton("Ok") { dialog: DialogInterface, _ ->
            findNavController().navigate(R.id.action_shipmentCreateFragment_to_shipmentListFragment)
        }
